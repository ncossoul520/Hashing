...
public class HashListLinearProbe {
    private static final int INITIAL_CAPACITY = 10;
    private static final double MAX_LOAD_FACTOR = 0.4;
    private static final double GROWTH_MULTIPLIER = 2.5;

    private static Entry[] arr, arr2;
    private int size;
    private static ArrayList<String> keys;

    public HashListLinearProbe() {
...
//            System.out.println("[INFO] rehashing");
            arr2 = new Entry[(int)(arr.length * GROWTH_MULTIPLIER)];
            rehash(arr, arr2);
            arr = arr2;
        }
